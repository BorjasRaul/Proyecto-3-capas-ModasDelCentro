...
{
    public class ConvertirnumeroToLetra
    {
            ...
            public void Numalet(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
            {
